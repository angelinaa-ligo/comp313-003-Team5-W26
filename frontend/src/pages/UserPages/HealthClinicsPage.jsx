...
export default function HealthClinicsPage() {
  ...
  const [selectedMapQuery, setSelectedMapQuery] = useState("veterinary clinic near Toronto");
      ...
      <div className="signup-box" style={{ maxWidth: "1400px", width: "100%" }}>
        ...
        >
          ...
          <div style={{ textAlign: "left" }}>
            <h3 style={{ marginBottom: "16px" }}>Active Clinic Locations</h3>
            ...
            {loading ? (
              ...
              >
                {clinics.map((clinic) => (
                  ...
                  >
                    <strong style={{ fontSize: "18px" }}>{clinic.name}</strong>
                    <br />
